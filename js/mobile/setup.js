...
var createDummyCamera = function (scene) {
    var camera = new BABYLON.FreeCamera('freeCam', new BABYLON.
        Vector3(30, 130, -40), scene);
    camera.setTarget(new BABYLON.Vector3(30, 0, -30));
    camera.speed = 3;
...
var createVjsCamera = function (scene) {
    var VJC = new BABYLON.VirtualJoysticksCamera("VJC", new BABYLON.Vector3(-1000, 54, 1200), scene);
    VJC.checkCollisions = true;
    VJC.setTarget(new BABYLON.Vector3(0, 27, 0));
    VJC.applyGravity = true;
    VJC.ellipsoid = new BABYLON.Vector3(30, 27, 30);
    VJC.speed = 7.0;
...
var createWall = function (name, scene, size, rotation, dir) {
    ...
    var customMaterial = new BABYLON.StandardMaterial("custommat", scene);
    customMaterial.ambientTexture = new BABYLON.Texture("../textures/claywall.jpg", scene);
